...
public class HashMapSelenium_Copy {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.cssSelector("input#user-name")).sendKeys(getUsername("user3"));
		driver.findElement(By.cssSelector("input#password")).sendKeys(getPassword("user3"));
